...
class Transaction {
    ...
    check() {
        ...
        //new code for let reward transactions pass the check
        if (this.type === 'reward') {
            return true;
        }
    ...
    static fromJson(data) {
        ...
        // Create a default to empty arrays in case it is undefined
        transaction.data.inputs = R.defaultTo([], transaction.data.inputs);
        transaction.data.outputs = R.defaultTo([], transaction.data.outputs);
